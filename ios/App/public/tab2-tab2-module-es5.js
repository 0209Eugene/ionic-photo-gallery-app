...
var PhotoService = /** @class */ (function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.savePicture(capturedPhoto)];
                    case 2:
                        savedImageFile = _a.sent();
                        this.photos.unshift(savedImageFile);
                        Storage.set({
                            key: this.PHOTO_STORAGE,
                            value: this.platform.is('hybrid') ?
                                JSON.stringify(this.photos) :
                                JSON.stringify(this.photos.map(function (p) {
                                    // Don't save the base64 representation of the photo data,
                                    // since it's already saved on the Filesystem
                                    var photoCopy = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, p);
    ...
    PhotoService.prototype.loadSaved = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var photos, _i, _a, photo, readFile;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Storage.get({ key: this.PHOTO_STORAGE })];
                    case 1:
                        photos = _b.sent();
    ...
    PhotoService.prototype.savePicture = function (cameraPhoto) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var base64Data, fileName;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readAsBase64(cameraPhoto)];
                    case 1:
                        base64Data = _a.sent();
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.getPhotoFile(cameraPhoto, fileName)];
                    case 3: 
    ...
    PhotoService.prototype.getPhotoFile = function (cameraPhoto, fileName) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var fileUri;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
var Tab2Page = /** @class */ (function () {
    ...
    Tab2Page = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_photo_service__WEBPACK_IMPORTED_MODULE_1__["PhotoService"]])
    ], Tab2Page);
    return Tab2Page;
}());
